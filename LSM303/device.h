...
# define TOP_BUTTON 		BUTTON0
# define MIDDLE_BUTTON		BUTTON1
# define BOTTOM_BUTTON		BUTTON2
# define ANY_BUTTON		(BUTTON0 | BUTTON1 | BUTTON2)
# define ALL_BUTTONS		(BUTTON0 | BUTTON1 | BUTTON2)
